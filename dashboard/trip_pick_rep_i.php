      ...
      <div class="invoice print">
        ...
        <div class="invoice-body">
            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT trips.*, vehicle.* FROM trips INNER JOIN vehicle ON trips.vehicleID = vehicle.vehicleID WHERE trips.vehicleID = :vehicleID AND trips.created_at BETWEEN :start_date AND :end_date");
          ...
          <?php 
                try {
                  require('../db/pdo.php');
                  $query = $dbCnx->query("SELECT * FROM trips WHERE vehicleID = {$vehicleID} AND trips.created_at BETWEEN '{$_GET['sdate']}' AND '{$_GET['edate']}'");
                  
          ?>
                    <p id="invoice-total-amount">Total Trips:  <?=$query->rowCount()?><span></span></p>
