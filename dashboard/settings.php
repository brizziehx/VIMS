            ...
            <div class="grid main">
                ...
                <div class="bottom-card">
                    <form action="" method="post" enctype="multipart/form-data">
                        <p style="display: flex; justify-content:space-between; border-bottom: 1px #eee solid; padding-bottom:5px;margin-bottom:5px;">Profile Details</p>
                        <div class="img" style="margin-bottom: 10px;">
                            <img src="../images/<?=$row['image']?>" id="uploadedAvatar">
                            <a class="btn-change" href="change_pass.php">Change Password</a>
                        </div>
                        <div class="input_row">
                            <div class="inputBox">
                                <span>Firstname</span>
                        ...
                        <div class="input_row">
                            ...
                            <div class="inputBox">
                                <span>Gender</span>
                                <input  value="<?=$row['gender']?>" disabled>
                            </div>
                        ...
                        <div class="input_row">
                            <div class="inputBox">
                                ...
                                <input style="text-transform: capitalize;" value="<?=$row['usertype']?>" disabled>
                                
                            </div>
                            <div class="inputBox">
                                <span>Created At</span>
                                <input value="<?=date('jS F Y - H:i:s', strtotime($row['created_at']))?>" disabled>
                            </div>
                            <div class="inputBox">
                                <span>Updated At</span>
                                <input value="<?=($row['updated_at'] != '') ? date('jS F Y - H:i:s', strtotime($row['updated_at'])): 'NIL'?>" disabled>
                            </div>
                        </div>
                        <!--  -->
