    ...
    if(isset($_POST['submit'])) {
        ...
        if(empty($odometer_after)) {
            ...
            if(!preg_match("/^[0-9]+$/", $odometer_after)) {
                $errors['odometer_after'] = 'Please enter valid Kilometres';
            }
        }
            ...
            <div class="grid main">
                ...
                <div class="top_card">
                    <div class="bread-cumb">
                        <a href="index.php">Dashboard</a> > <a href="trips.php" id="sec">Trips</a> > <span>Trip Details</span>
                    </div>
                </div>
                <div class="bottom-card">
                    <form action="" method="post" enctype="multipart/form-data">
                    <p style="border-bottom: 1px #eee solid; padding-bottom:5px;margin-bottom:5px">Details</p>
                        <div class="input_row">
                            <div class="inputBox">
                        ...
                        <div class="input_row">
                            <div class="inputBox">
                                ...
                                <input type="datetime-local" name="arrival_time" value="<?=$row2['arrival_time'] ?? ''?>" <?=($row2['arrival_time'] != '') ? 'disabled' : ''?>>
                            ...
                            <div class="inputBox">
                                ...
                                <input type="text" <?=($row2['km_after'] != '') ? 'disabled' : ''?>  name="odometer_after" value="<?=$odometer_after ?? $row2['km_after']?>">
                                <p><?=$errors['odometer_after'] ?? ''?></p>
                            </div>
                        </div>
                        <div class="input_row" style="justify-content: flex-start;margin-bottom:10px">
                            <?php if($row2['km_after'] != ''): ?>
                                <div class="inputBox" style="margin-right: 20px";>
                                    <span>Full trip</span>
                                    <input <?=($row2['km_after'] != '') ? 'disabled' : ''?>  name="odometer_after" value="<?=$row2['km_after'] - $row2['km_before'].' KM'?>">
                                    <p><?=$errors['odometer_after'] ?? ''?></p>
                                </div>
                            <?php endif; ?>
