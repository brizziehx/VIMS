      ...
      <div class="invoice print">
        ...
        <div class="invoice-head">
          <div class="head client-data">
            ...
            <p>Monthly Maintenance Report</p> 
            <p><?=$month.' '.date('Y')?></p>
          </div>
        </div>
        <!-- invoice body-->
            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT maintenance.*, vehicle.* FROM maintenance INNER JOIN vehicle ON maintenance.vehicleID = vehicle.vehicleID WHERE maintenance.vehicleID = :vehicleID AND month(maintenance.last_maintenance) = :month");
