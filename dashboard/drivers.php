            ...
            <div class="grid main">
                ...
                <div class="top_card">
                    <div class="bread-cumb">
                        <a href="index.php">Dashboard</a> > <span>Drivers</span>
                    </div>
                    <a href="add_user.php" class="add-btn"><i class="bx bx-user-plus"></i>new user</a>
                </div>
                <div class="top_card" style="align-items: center;">
                    <p style="color:black">All Drivers</p>
                    <input type="text" name="searchInput" id="searchInput" placeholder="Search Drivers..">
                </div>
                <div class="bottom-card">
                    <table id="myTable">
                        ...
                        <?php 
                            try {
                                require('../db/pdo.php');
                                $stmt = $dbCnx->prepare('SELECT * FROM users WHERE usertype = \'driver\' ORDER BY usertype ASC');
                                $stmt->execute();
