        ...
        if(!array_filter($errors)) {
            ...
            try {
                require('../db/pdo.php');
                    ...
                    $stmt = $dbCnx->prepare("INSERT INTO routes(start, to_, end, created_at) VALUES(:start, :to, :end, :created_at)");
...
<head>
    ...
    <title>Add route | Vehicle Information Management System</title>
    ...
    <script>
        function success() {
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Route Has Been Added Successfully',
            ...
            <div class="grid main">
                ...
                <div class="top_card">
                    <div class="bread-cumb">
                        <a href="index.php">Dashboard</a> > <a href="routes.php" id="sec">Routes</a> > <span>New Route</span>
                    </div>
                </div>
                <div class="bottom-card">
                    <form action="" method="post">
                        <p style="border-bottom: 1px #eee solid; padding-bottom:5px;margin-bottom:5px">Route Registration</p>
                        <div class="input_row">
                            <div class="inputBox">
