            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT maintenance.*, vehicle.* FROM maintenance INNER JOIN vehicle ON maintenance.vehicleID = vehicle.vehicleID WHERE maintenance.last_maintenance BETWEEN :start_date AND :end_date");
