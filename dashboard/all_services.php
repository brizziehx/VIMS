...
<head>
    ...
    <title>All Services | Vehicle Information Management System</title>
    ...
    <script>
        ...
        function deleteOK() {
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Service History Deleted Successfully',
                showConfirmButton: false,
                timer: 2000
            })
        }
            ...
            <div class="grid main">
                ...
                <div class="top_card">
                    <div class="bread-cumb">
                        <a href="index.php">Dashboard</a> > <span>All Services</span>
                    </div>
                    <a href="service.php" class="add-btn"><i class="bx bxs-wrench"></i>Add Service</a>
                </div>
                <div class="top_card" style="align-items: center;">
                    <p style="color:black">Service History </p>
                    <input type="text" name="searchInput" id="searchInput" placeholder="Search Service history..">
                </div>
                            ...
                            try {
                                ...
                                foreach($rows as $row):
                                    ...
                                    $km_until = isServiceDue($curr_km, $row['current_km'] + $row['length']);
                                     $next_service = $row['current_km'] + $row['length'];
                                ...
                                ?>
                                    <tr id="trow">
                                        ...
                                        <td><a href="edit_service.php?id=<?=$row['oilD']?>"><i class="bx bx-edit icon update"></i></a><a href="delete_service.php?id=<?=$row['oilD']?>"><i class="bx bx-trash icon del"></i></a></td>
