<?php
    ...
    try {
        ...
        $stmt = $dbCnx->prepare("SELECT fuel.*, vehicle.registration_no, vehicle.fuel FROM fuel INNER JOIN vehicle ON fuel.vehicleID = vehicle.vehicleID WHERE year(fuel.purchased_on) = year(curdate())");
...
<head>
    ...
    <title>Annual Fuel Report | VIMS</title>
