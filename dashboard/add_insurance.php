    ...
    if(isset($_POST['submit'])) {
        ...
        if(!array_filter($errors)) {
            try {
                ...
                $stmt = $dbCnx->prepare('INSERT INTO insurance(insure, vehicleID, start, end, type, amount, created_at) VALUES (:insure, :vehicleID, :start, :end, :type, :amount, :created_at)');
...
<head>
    ...
    <title>New Insurance | Vehicle Information Management System</title>
    ...
    <script>
        function success() {
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Insurance Details Has Been Added Successfully',
            ...
            <div class="grid main">
                ...
                <div class="top_card">
                    <div class="bread-cumb">
                        <a href="index.php">Dashboard</a> > <a href="insurance.php" id="sec">Insurance</a> > <span>New Insurance</span>
                    </div>
                </div>
                <div class="bottom-card">
                    <form action="" method="post" enctype="multipart/form-data">
                    <p style="border-bottom: 1px #eee solid; padding-bottom:5px;margin-bottom:5px">Insurance Registration</p>
                        <div class="input_row">
                            <div class="inputBox">
                                <span>Insurer</span>
                                <input type="text" name="insurer" value="<?=$insurer?>" placeholder="Eg. Britam Insurance">
                                <p><?=$errors['insurer']?></p>
                            </div>
                            <div class="inputBox">
                        ...
                        <div class="input_row">
                            <div class="inputBox">
                                ...
                                <input type="text" name="cost" value="<?=$cost?>" placeholder="Eg. 118000">
                                <p><?=$errors['cost']?></p>
                            </div>
                            <div class="inputBox">
                        ...
                        <div class="input_row">
                            <div class="inputBox">
                                <input type="submit" name="submit" value="Add Insurance"> 
                            </div>
                            <?=$errors['error'] ?? ''?>
                            <?=$errors['success'] ?? ''?>
                        </div>
