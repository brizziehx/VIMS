      ...
      <div class="invoice print">
        ...
        <div class="invoice-body">
            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT trips.*, vehicle.* FROM trips INNER JOIN vehicle ON trips.vehicleID = vehicle.vehicleID WHERE trips.vehicleID = :vehicleID AND month(trips.created_at) = :month");
          ...
          <?php 
                try {
                  require('../db/pdo.php');
                  $query = $dbCnx->query("SELECT * FROM trips WHERE vehicleID = {$vehicleID} AND month(created_at) = {$_GET['month']}");
