            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT maintenance.*, vehicle.* FROM maintenance INNER JOIN vehicle ON maintenance.vehicleID = vehicle.vehicleID WHERE month(maintenance.last_maintenance) = :month");
