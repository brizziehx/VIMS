      ...
      <div class="invoice print">
        ...
        <div class="invoice-body">
            ...
            <tbody>
              <?php 
                try {
                  ...
                  $stmt = $dbCnx->prepare("SELECT trips.*, vehicle.* FROM trips INNER JOIN vehicle ON trips.vehicleID = vehicle.vehicleID WHERE trips.vehicleID = :vehicleID AND year(trips.created_at) = year(curdate())");
          ...
          <?php 
                try {
                  require('../db/pdo.php');
                  $query = $dbCnx->query("SELECT * FROM trips WHERE vehicleID = {$vehicleID} AND year(created_at) = year(curdate())");
